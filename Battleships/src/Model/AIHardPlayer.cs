...
// is not destroyed it will shoot the other way. If the ship is still not destroyed, then
// the AI knows it has hit multiple ships. Then will try to destoy all around the tiles
// that have been hit.
